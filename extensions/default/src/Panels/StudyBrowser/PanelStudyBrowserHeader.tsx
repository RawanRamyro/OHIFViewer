...
import { ProtocolNavigationButtons } from '@ramyro/addons';
...
function PanelStudyBrowserHeader({
  ...
  return (
    <div className="bg-muted flex h-[40px] select-none rounded-t p-2">
      <div className={'flex h-[24px] w-full select-none items-center text-[14px]'}>
        <div className="flex w-full items-center gap-[10px]">
          ...
          {/* Center section - Protocol Navigation */}
