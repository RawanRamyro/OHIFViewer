...
export default function PanelStudyBrowserTracking({
  ...
  const { displaySetService, uiModalService,hangingProtocolService,
    uiNotificationService, measurementService,studyPrefetcherService,
    customizationService, viewportGridService } =
